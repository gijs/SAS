 ...
 module.exports = {
 	...
 	*/
 	add: function(req, res){
		server.createTenant(req, res, function(errObj, success){
 			if(errObj){
 					res.send(errObj);
 			}else if(success){
 					res.send({'success':true, 'message':'Successfully created the account password will be sent to your email.'});
			}			
 		});
 	},
